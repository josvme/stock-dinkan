...
object DownloadStockListFromYahoo extends App {

  println("Welcome to StockDinkan Downloader from Yahoo")
  val stockListFile = s"./stocklist/stocks.json"
  val config = YahooStockConfig.getConfig
  val stocks = IO.delay({
